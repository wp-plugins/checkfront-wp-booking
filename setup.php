			...
			<div class="inside" style="padding: 0 10px">
				...
				<tbody>
					<tr valign="top">
						...
						<td id="CF_status"><em>Location of your Checkfront Admin [<a href="https://www.checkfront.com/start">Create</a>]</em></td>
					</tr>
					<tr>
					<td>
		...
		<div class="postbox">
			...
			<div class="inside" style="padding: 0 10px">
				...
				<tbody>
					...
					<tr>
						<td scope="row" colspan="2"><strong style="font-size: 14px">[checkfront]</strong></td>
					</tr>
					<tr>
					<td>You can supply additional arguments to the shortcode to change the and behaviour:
					</td>
					</tr>
					<tr><td>
						<a  class="button-primary" href="https://<?php echo $Checkfront->host?>/manage/extend/integrate/wordpress" value=" Update " target="_blank" id="shortcode_generator"/>Launch Shortcode Generator</a>
					</td>
					</tr>
					<tr>
					<td><strong>Require help?</strong>  Please see our <a href="http://www.checkfront.com/support/wordpress">wordpress setup guide</a> in our  <a href="http://www.checkfront.com/support/">support library</a> or <a href="http://www.checkfront.com/conatct/">contact us</a> and we'd be happy to assist.</td>
					</td>
					</tr>
				</tbody>
			</table>
...
<p style="float: left; color: #555">&copy; Checkfront Inc <?php print date('Y')?></p>

<p style="float: right; color: #999">
<a style="color: #777;  font-size: 11px" href="http://www.checkfront.com/">Learn More</a>
&nbsp;|&nbsp; 
<a style="color: #777;  font-size: 11px" href="http://www.checkfront.com/">Recent Updates</a>
&nbsp;|&nbsp; 
