...
function checkfront_conf() {
	...
	add_menu_page('Setup', 'Checkfront', 'activate_plugins', __FILE__, 'checkfront_setup',$icon);
...
//		'pipe_url'=>'https://www.checkfront.com/wp-content/plugins/' . basename(dirname(__FILE__)) . '/pipe.html',
